...
function Cards(animeData) {
    ...
    animeData.forEach(object => {
        console.log(object.mal_id);
        main.innerHTML += `<div class="card">
                             <div class="card__content" id="${object.mal_id}">
                             <a href="/Home/Details/${object.mal_id}" class = 'img__link'><img class="img" src="${object.images.jpg.image_url}" alt="" id="${object.id}"></a>
                                <div class = "card__text-rate"><span>${object.score}★</span></div>
                             </div>
